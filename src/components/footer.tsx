...
export function Footer() {
  ...
  return (
    <div
      className={`fixed bottom-0 z-10 w-full bg-white md:py-2 shadow-[4px_0px_10px_rgba(0,0,0,0.25)] transition-opacity duration-500 ease-in-out ${showFooter ? 'opacity-70' : 'opacity-0 pointer-events-none'
        }`}
    >
      <div className='hidden md:flex justify-center items-center gap-5 px-10'>
        <Link href="" target="_blank" className='w-[450] opacity-70 hover:opacity-100 transition-opacity duration-300' >
          <img src="/images/footer_line_pc.png" alt="footer_line_pc" className="w-[450]" />
        </Link>
        <Link href="tel:090-0000-0000" target="_blank" className='w-[450] opacity-70 hover:opacity-100 transition-opacity duration-300'>
      ...
      <div className='flex justify-center items-center md:hidden'>
        <div className='flex flex-1 items-center justify-center bg-[#06C755]'>
          <Link href="" target="_blank" className='w-[15vw] sm:w-[80] opacity-70 hover:opacity-100 transition-opacity duration-300'>
        ...
        <div className='flex flex-1 items-center justify-center bg-[#F59DA5]'>
          <Link href="tel:090-0000-0000" target="_blank" className='w-[15vw] sm:w-[80] opacity-70 hover:opacity-100 transition-opacity duration-300'>
